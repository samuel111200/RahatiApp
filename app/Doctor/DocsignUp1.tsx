// app/Doctor/DocsignUp1.tsx  —  Doctor sign-up step 1
...
export default function DoctorSignUp1Screen() {
  ...
  const validate = () => {
    ...
    else if (isNaN(Number(age)) || +age < 22 || +age > 100) e.age = t.invalidAge;
    ...
    <SafeAreaView style={styles.safe}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity onPress={() => router.replace('/Doctor/Docsignin')} style={styles.backBtn}>
          ...
          <View style={styles.card}>
            ...
            <InputField label={t.age} placeholder="30" value={age} onChangeText={setAge} keyboardType="numeric" error={errors.age} rtl={isRTL} />
...
const styles = StyleSheet.create({
  ...
  backBtn: { marginTop: Spacing.base, alignSelf: 'flex-start', width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.primaryUltraLight, alignItems: 'center', justifyContent: 'center' },
