      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          <View>
            ...
            <View style={styles.onlineRow}>
              ...
              <Text style={styles.onlineText}>نشط الآن</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity style={styles.headerActionBtn} activeOpacity={0.8}>
            <Ionicons name="call-outline" size={20} color={DOC_COLOR} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.headerActionBtn} activeOpacity={0.8}>
            <Ionicons name="ellipsis-vertical" size={20} color={DOC_COLOR} />
          </TouchableOpacity>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  headerAvatar: {
    ...
    backgroundColor: DOC_COLOR_LIGHT,
    alignItems: 'center', justifyContent: 'center',
    borderWidth: 2, borderColor: DOC_COLOR + '40',
  },
