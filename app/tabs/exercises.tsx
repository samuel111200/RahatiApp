...
const DEFAULT_THERAPY_EXERCISES: Exercise[] = [
  ...
  },
  {
    key: 'hipStrength',
    emoji: '🦵',
    title: 'تمرين مشي الوركين (Hip Marching)',
    ...
    bg: '#E8F1FB',
    accent: '#D0E5F7',
    desc: 'تقوية مفاصل الورك وعضلاتها وتحسين حركة الساقين أثناء الجلوس',
  ...
  },
  {
    ...
    bg: '#E8F1FB',
    accent: '#D0E5F7',
    desc: 'تقوية عضلات الفخذ الخلفية وتحسين التوازن أثناء الوقوف',
  ...
  },
  {
    ...
    emoji: '🦶',
    title: 'إرخاء وتر أكيليس (Achilles Tendon Release)',
    ...
    bg: '#E8F1FB',
    accent: '#D0E5F7',
    desc: 'إطالة وإرخاء وتر أكيليس والعضلات المشدودة في الجزء الخلفي من الساق والكعب',
  ...
  },
  {
    ...
    emoji: '💺',
    title: 'تمرين رفع الذراع على الكرسي (Arm Raise)',
    ...
    bg: '#E8F1FB',
    accent: '#D0E5F7',
    desc: 'تحسين مرونة الكتف وتقوية عضلات الذراع العلوية مع تحسين التنفس',
...
const DEFAULT_YOGA_EXERCISES: Exercise[] = [
  ...
  },
  {
    key: 'lyingTwistArms',
    emoji: '🤸',
    title: 'تمرين التدحرج لأعلى (Roll-ups) - بيلاتس',
    ...
    bg: '#E8F5EF',
    accent: '#D6EFE3',
    desc: 'تقوية عضلات البطن والظهر وتحسين مرونة العمود الفقري من خلال حركة التدحرج اللطيفة',
...
const DEFAULT_AEROBIC_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    bg: '#FDF0EB',
    accent: '#FAE2D6',
    desc: 'تحسين التوازن وتنشيط الدورة الدموية في القدمين والساقين أثناء الوقوف',
  ...
  },
  {
    ...
    bg: '#FDF0EB',
    accent: '#FAE2D6',
    desc: 'تحسين مرونة مفصل الركبة وتقوية العضلات المحيطة به',
  ...
  },
  {
    ...
    bg: '#FDF0EB',
    accent: '#FAE2D6',
    desc: 'تحسين مرونة العمود الفقري وتقوية عضلات الجذع والظهر',
  ...
  },
  {
    ...
    bg: '#FDF0EB',
    accent: '#FAE2D6',
    desc: 'تقوية عضلات أسفل الساقين والقدمين وتحسين التوازن والثبات',
...
const DEFAULT_ENDURANCE_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    bg: '#FCEEF8',
    accent: '#F8D6F0',
    desc: 'تحسين مرونة الجذع والظهر وتخفيف التيبس والألم في منطقة الظهر',
...
const DEFAULT_STRENGTH_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    bg: '#F0EBF8',
    accent: '#E0D5F2',
    desc: 'تقوية عضلات الذراعين والساقين معاً مع تحسين التنسيق والتوازن',
  ...
  },
  {
    ...
    emoji: '🏋️',
    title: 'تمرين السحب أثناء الوقوف (Standing Row)',
    ...
    bg: '#F0EBF8',
    accent: '#E0D5F2',
    desc: 'تقوية عضلات الظهر والذراعين وجذع الجسم باستخدام شريط مقاومة أثناء الوقوف',
  ...
  },
  {
    key: 'backBridgeLying',
    emoji: '🌉',
    title: 'تمرين تقوس الظهر أثناء الاستلقاء (Back Bridge)',
    ...
    bg: '#F0EBF8',
    accent: '#E0D5F2',
    desc: 'تقوية عضلات الظهر السفلي والأرداف وتحسين استقرار الحوض',
...
const DEFAULT_COORDINATION_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    bg: '#E6F5F3',
    accent: '#C8EBE7',
    desc: 'تحسين التنسيق الحركي ومرونة الجذع وتقوية عضلات البطن والظهر',
  ...
  },
  {
    ...
    emoji: '⚖️',
    title: 'تمرين التوازن الجانبي أثناء الجلوس',
    ...
    bg: '#E6F5F3',
    accent: '#C8EBE7',
    desc: 'تحسين التوازن الجانبي وتقوية عضلات الجانب والجذع أثناء الجلوس بأمان',
