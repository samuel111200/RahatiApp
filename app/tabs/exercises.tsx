...
const DEFAULT_STRENGTH_EXERCISES: Exercise[] = [
  {
    key: 'Forwardbend',
    emoji: '🚶',
    title: 'لف الجسم ولمس الركبة المعاكسة اثناء الجلوس.',
    ...
    bg: '#F0EBF8',
    accent: '#E0D5F2',
    desc: 'يساعد هذا التمرين على تحسين مرونة الجذع والتناسق الحركي.',
  ...
  },
  {
    ...
    bg: '#F0EBF8',
    accent: '#E0D5F2',
    desc: 'يساعد هذا التمرين على تحسين مرونة الجزء العلوي من الجسم، وتقوية عضلات الذراعين والكتفين، كما يعزز التناسق الحركي بين الذراعين والجذع.',
...
const DEFAULT_COORDINATION_EXERCISES: Exercise[] = [
  ...
  },
  {
    key: 'Jumpingjacks',
    emoji: '🔄',
    title: 'تمرين القفز مع فتح وضم الذراعين والساقين.',
    ...
    bg: '#E6F5F3',
    accent: '#C8EBE7',
    desc: 'التمرين يساعد على تحسين التوافق الحركي والتوازن واللياقة البدنية.',
  ...
  },
  {
    ...
    emoji: '⚖️',
    title: 'تمرين التوازن  أثناء الجلوس',
