...
const EXERCISE_VIDEOS: Record<string, any> = {
  ...
  marchingInPlace:          { uri: 'https://res.cloudinary.com/dyrf3eqtn/video/upload/v1781048611/jurf87w2kcxl9ozeopli.mp4' },
  Forwardbend:              { uri: 'https://res.cloudinary.com/dyrf3eqtn/video/upload/v1781048601/t9ftlcnfodnmn5gcvu9l.mp4' },
  chairSquat:               { uri: 'https://res.cloudinary.com/dyrf3eqtn/video/upload/v1781048615/ivfcwhmzso3xhewrj8v5.mp4' },
  ...
  kneeCircleStanding:       { uri: 'https://res.cloudinary.com/dyrf3eqtn/video/upload/v1781048606/agde0vt0ktmjbqjatc7t.mp4' },
