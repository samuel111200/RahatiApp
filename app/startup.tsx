        ...
        <View style={{ width: "100%", paddingHorizontal: 28 }}>
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              router.replace({ pathname: "/langchoose" } as any);
            }}
            activeOpacity={0.88}
          >
            <LinearGradient
...
const styles = StyleSheet.create({
  root: { flex: 1 },
  butterfly:      { position: "absolute", top: height * 0.38, right: width * 0.14 },
  butterflySmall: { position: "absolute", top: height * 0.33, right: width * 0.3, opacity: 0.6 },
  ...
  ctaBtn:         { borderRadius: 50, overflow: "hidden", shadowColor: "#7C5CBF", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.45, shadowRadius: 16, elevation: 8, marginBottom: 14 },
  ctaGradient:    { paddingVertical: 17, alignItems: "center", borderRadius: 50 },
  ctaText:        { color: "#fff", fontSize: 17, fontWeight: "700", letterSpacing: 0.5 },
  footerNote:     { fontSize: 12, color: "rgba(255, 255, 255, 0.55)", textAlign: "center", fontWeight: "bold" },
});